...
export function OptionTickerAutocomplete({
  ...
  const filteredOptions: OptionSearchResult[] = (data?.pages ?? []).flatMap(
    (page) =>
      page.results.map((opt) => {
        ...
        return {
          ...opt,
          optionType,
          underlyingTicker: base || undefined,
  ...
  return (
    <div className="space-y-2">
      ...
      <div ref={underlyingContainerRef} className="relative">
        ...
        {selectedUnderlying ? (
          ...
          <div className="relative">
            ...
            <input
              ...
              onKeyDown={(e) =>
                e.key === 'Escape' && setIsUnderlyingOpen(false)
              }
        ...
        {isUnderlyingOpen && (
          <div className="absolute z-50 w-full mt-1 bg-surface-container-low border border-outline-variant/20 rounded-xl shadow-xl max-h-56 overflow-y-auto">
            ...
            ) : underlyingResults.filter((a) => a.type === 'STOCK').length ===
              0 ? (
      ...
      <div ref={optionContainerRef}>
        {!hideLabel && (
          <label
            className={`text-[10px] font-bold uppercase tracking-[0.15em] block mb-2 transition-colors ${selectedUnderlying ? 'text-on-surface-variant' : 'text-on-surface-variant/40'}`}
          >
            Ticker Opção
          </label>
        )}
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={
                selectedUnderlying
                  ? 'Buscar opção…'
                  : 'Selecione o Ticker Pai primeiro'
              }
